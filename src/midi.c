...
void WEAK midi_error(int time, const uint8_t *p, const uint8_t *file_start, const char *msg)
{
}
...
void WEAK sysex_info(int time, const uint8_t *p, const uint8_t *buf, int len, const MIDI_Header *hdr)
{
}
